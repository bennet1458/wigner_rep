...
axes[0, 0].set_title("Wigner function after kick")
...
axes[0, 1].set_title("Wigner function after time evolution")
...
axes[1, 0].set_title("Wigner function after second kick")
...
axes[1, 1].set_title("Wigner function after second kick and time evolution")
