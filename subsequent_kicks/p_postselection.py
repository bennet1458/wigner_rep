...
Z2 =  wf .kick(W0, X, P, dp, q, phi0, hbar)
...
axes[0, 0].set_title("One small kick")
...
axes[0, 1].set_title("{} small kicks".format(n))
...
im3 = axes[1, 0].plot(x, wf.x_marginal(Z2, p), linewidth=2)
axes[1, 0].set_xlabel("x [m]")
axes[1, 0].set_ylabel("Marginal")


# Subplot 4: Wigner function after second kick and time evolution
im4 = axes[1, 1].plot(x, wf.x_marginal(Z, p), linewidth=2)
