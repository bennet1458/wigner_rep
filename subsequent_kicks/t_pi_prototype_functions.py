...
W2 = wfs.kick(W2, q, phi+np.pi, hbar)
Z2 = W2(X, P)

W3 = wfs.W0(sigma_x, sigma_p, hbar)
W3 = wfs.kick(W3, q, phi+np.pi, hbar)
...
axes[0, 1].set_title("Kicked with phase shift")
...
axes[0, 2].set_title("Kicked with phase shift and time evolution")
